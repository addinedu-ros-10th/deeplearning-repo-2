...
class Tcp_client_manager():
    ...
    def send_data(self, data):
        ...
        time_array = [current_time.year, current_time.month, current_time.day, current_time.hour, current_time.minute, current_time.second]
        if (len(data.video) == 0):
            send_data = struct.pack("BBIIIIIIBIP",self.deviceManager_ID, self.situationDetector_ID, self.PATROL_NUMBER, time_array, data.deviceStatus, len(data.video))
