...
class LogViewerDialog(QDialog):
    ...
    def setupUi(self):
        ...
        self.video_display = AspectRatioWidget()
...
class PatrolDashboard(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tab_widget.addTab(video_tab, "비디오 스트림")
        ...
        control_layout.addWidget(self.log_open_button)
        ...
        control_layout.addWidget(trigger_groupbox)
        ...
        self.tab_widget.addTab(control_tab, "제어 패널")
